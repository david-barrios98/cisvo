...
<div class="container-fluid">
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<form action="<?php echo SERVERURL?>ajax/vehiculoAjax.php" method="POST" 
						...
						<div class="row">
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<input class="form-control" type="text" name="placa-txt" id="placa-txt" maxlength="7" required>
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<select class="form-control" name ="tipovehiculo-txt" id="tipovehiculo-txt" required>
									</select>
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-6">
								<div class="form-group label-floating">
									...
									<select class="form-control" name ="marcavehiculo-txt" id="marcavehiculo-txt" required>
									</select>
								</div>
							</div>
							<div class="col-xs-12 col-sm-6">
				...
				<div class="RespuestaAjax" id="RespuestaAjax"></div><!--MOSTRARÁ LA RESPUESTA DEL AJAX-->
			</form>
		</div>
	</div>
</div>